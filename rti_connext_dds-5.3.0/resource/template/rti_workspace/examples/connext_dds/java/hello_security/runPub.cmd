...
IF NOT DEFINED RTI_OPENSSLHOME (
    ECHO "RTI_OPENSSLHOME environment variable is not set"
    GOTO ENDSCRIPT
)
...
set Path=%NDDSHOME%\lib\%RTI_EXAMPLE_ARCH%;%RTI_OPENSSLHOME%\%RTI_EXAMPLE_ARCH%\release\bin;%Path%
