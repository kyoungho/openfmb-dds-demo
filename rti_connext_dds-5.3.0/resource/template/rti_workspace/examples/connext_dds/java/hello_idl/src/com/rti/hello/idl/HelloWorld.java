...
public class HelloWorld   implements Copyable, Serializable{
    ...
    public String prefix=  "" ; /* maximum length = ((com.rti.hello.idl.HELLODDS_MAX_STRING_SIZE.VALUE)) */
    public int sampleId= 0;
    public ByteSeq payload =  new ByteSeq((com.rti.hello.idl.HELLODDS_MAX_PAYLOAD_SIZE.VALUE));
