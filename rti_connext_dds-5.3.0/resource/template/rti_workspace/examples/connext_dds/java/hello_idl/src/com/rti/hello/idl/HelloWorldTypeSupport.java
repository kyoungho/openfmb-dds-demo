...
public class HelloWorldTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((com.rti.hello.idl.HELLODDS_MAX_STRING_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, (com.rti.hello.idl.HELLODDS_MAX_PAYLOAD_SIZE.VALUE));
        if (include_encapsulation) {
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.prefix );
        ...
        currentAlignment  +=   CdrPrimitiveType.BYTE.getSequenceSerializedSize(
            epd.getAlignment(currentAlignment) , typedSrc.payload );      
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.prefix,(com.rti.hello.idl.HELLODDS_MAX_STRING_SIZE.VALUE));

            dst.writeInt(typedSrc.sampleId);

            dst.writeByteSeq(typedSrc.payload,(com.rti.hello.idl.HELLODDS_MAX_PAYLOAD_SIZE.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.prefix = src.readString((com.rti.hello.idl.HELLODDS_MAX_STRING_SIZE.VALUE));
                typedDst.sampleId = src.readInt();
                src.readByteSequence(typedDst.payload, (com.rti.hello.idl.HELLODDS_MAX_PAYLOAD_SIZE.VALUE));
