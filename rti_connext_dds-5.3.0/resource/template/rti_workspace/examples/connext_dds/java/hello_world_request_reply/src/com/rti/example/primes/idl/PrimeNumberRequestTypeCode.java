...
public class  PrimeNumberRequestTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("n", false, (short)-1,  false,(TypeCode) TypeCode.TC_LONG,0 , false);__i++;
        sm[__i]=new  StructMember("primes_per_reply", false, (short)-1,  false,(TypeCode) TypeCode.TC_LONG,1 , false);__i++;
