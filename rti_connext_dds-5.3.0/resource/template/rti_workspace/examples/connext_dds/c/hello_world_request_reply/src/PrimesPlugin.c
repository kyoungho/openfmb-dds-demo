    ...
    const PrimeNumberRequest *sample)
{
    ...
    result = PrimeNumberRequestPlugin_serialize(
    ...
    unsigned int length)
{
    ...
    PrimeNumberRequest_finalize_optional_members(sample, RTI_TRUE);
    return PrimeNumberRequestPlugin_deserialize_sample( 
        NULL, sample,
    ...
    void *endpoint_plugin_qos)
{
    ...
    RTIBool result;
    const char *METHOD_NAME = "PrimeNumberRequestPlugin_deserialize";
...
unsigned int 
PrimeNumberRequestPlugin_get_serialized_sample_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    ...
    unsigned int current_alignment)
{
    ...
    size = PrimeNumberRequestPlugin_get_serialized_sample_max_size_ex(
...
unsigned int
PrimeNumberRequestPlugin_get_serialized_key_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
{
    ...
    current_alignment += PrimeNumberRequestPlugin_get_serialized_sample_max_size_ex(
    ...
    unsigned int current_alignment)
{
    ...
    size = PrimeNumberRequestPlugin_get_serialized_key_max_size_ex(
        endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
{
    char * position = NULL;
    const char *METHOD_NAME = "PrimeNumberCalculationStatusPlugin_serialize";
    ...
    if(serialize_sample) {
        ...
        if (*sample != REPLY_IN_PROGRESS && *sample != REPLY_COMPLETED && *sample != REPLY_ERROR){
            RTICdrLog_exception(
                METHOD_NAME, 
    ...
    void *endpoint_plugin_qos)
{
    ...
    char * position = NULL;
    DDS_Enum enum_tmp;
    const char *METHOD_NAME = "PrimeNumberCalculationStatusPlugin_deserialize_sample";
            ...
            *sample=REPLY_ERROR;
            ...
            default:
            {
                ...
                if (ap->acceptUnknownEnumValue) {
                    PrimeNumberCalculationStatus_initialize(sample);
                } else {
...
unsigned int 
PrimeNumberCalculationStatusPlugin_get_serialized_sample_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment += PrimeNumberCalculationStatusPlugin_get_serialized_sample_max_size_ex(
        endpoint_data,
        NULL,
...
unsigned int
PrimeNumberCalculationStatusPlugin_get_serialized_key_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_sample) {
        ...
        if(!PrimeNumberCalculationStatusPlugin_serialize(
            endpoint_data,
            (const PrimeNumberCalculationStatus*) &sample->status,
            stream,
            RTI_FALSE, encapsulation_id,
            RTI_TRUE,
            endpoint_plugin_qos)) {
    ...
    const PrimeNumberReply *sample)
{
    ...
    result = PrimeNumberReplyPlugin_serialize(
        (PRESTypePluginEndpointData)&epd, sample, &stream, 
        RTI_TRUE, RTICdrEncapsulation_getNativeCdrEncapsulationId(), 
        RTI_TRUE, NULL);  
    ...
    unsigned int length)
{
    ...
    PrimeNumberReply_finalize_optional_members(sample, RTI_TRUE);
    return PrimeNumberReplyPlugin_deserialize_sample( 
        NULL, sample,
        &stream, RTI_TRUE, RTI_TRUE, 
        NULL);
}
    ...
    void *endpoint_plugin_qos)
{
    ...
    RTIBool result;
    const char *METHOD_NAME = "PrimeNumberReplyPlugin_deserialize";
    if (drop_sample) {} /* To avoid warnings */
...
unsigned int 
PrimeNumberReplyPlugin_get_serialized_sample_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    ...
    unsigned int current_alignment)
{
    ...
    size = PrimeNumberReplyPlugin_get_serialized_sample_max_size_ex(
        endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
    ...
    const PrimeNumberReply * sample) 
{
    ...
    current_alignment += PrimeNumberCalculationStatusPlugin_get_serialized_sample_size(
        ...
        current_alignment, (const PrimeNumberCalculationStatus*) &sample->status);
...
unsigned int
PrimeNumberReplyPlugin_get_serialized_key_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
{
    ...
    current_alignment += PrimeNumberReplyPlugin_get_serialized_sample_max_size_ex(
        endpoint_data, overflow,RTI_FALSE, encapsulation_id, current_alignment);
    ...
    unsigned int current_alignment)
{
    ...
    size = PrimeNumberReplyPlugin_get_serialized_key_max_size_ex(
        endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
