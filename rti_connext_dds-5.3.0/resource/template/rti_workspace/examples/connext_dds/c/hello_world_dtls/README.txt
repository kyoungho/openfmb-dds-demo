...
Open the generated solution file for your architecture witn Visual Studio. Build the
...
Run the subscriber by typing:
    ...
    objs\i86Win32VS2010\HelloWorld_subscriber.exe <Domain_ID> <Number_of_Samples>

and run the publisher by typing:

    objs\i86Win32VS2010\HelloWorld_publisher.exe <Domain_ID> <Number_of_Samples>
