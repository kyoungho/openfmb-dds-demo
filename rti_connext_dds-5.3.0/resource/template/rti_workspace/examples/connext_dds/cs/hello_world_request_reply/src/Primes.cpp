...
PrimeNumberCalculationStatus PrimeNumberCalculationStatus_get_default_value() {
    return PrimeNumberCalculationStatusHelper::PrimeNumberCalculationStatus_get_default_value();
}

PrimeNumberCalculationStatus PrimeNumberCalculationStatusHelper::PrimeNumberCalculationStatus_get_default_value() {
...
DDS_TypeCode* PrimeNumberCalculationStatus_get_typecode()
{
    ...
    static DDS_TypeCode_Member PrimeNumberCalculationStatus_g_tc_members[3]=
    {

        {
            ...
            (RTICdrLong)PrimeNumberCalculationStatus::REPLY_IN_PROGRESS, 
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            RTI_CDR_REQUIRED_MEMBER, /* Is a key? */
        ...
        }, 
        {
            ...
            (RTICdrLong)PrimeNumberCalculationStatus::REPLY_COMPLETED, 
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            RTI_CDR_REQUIRED_MEMBER, /* Is a key? */
        ...
        }, 
        {
            ...
            (RTICdrLong)PrimeNumberCalculationStatus::REPLY_ERROR, 
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            RTI_CDR_REQUIRED_MEMBER, /* Is a key? */
...
PrimeNumberReply::PrimeNumberReply() {
    ...
    status = PrimeNumberCalculationStatusHelper::PrimeNumberCalculationStatus_get_default_value();
}
...
System::Boolean PrimeNumberReply::copy_from(PrimeNumberReply^ src) {
    ...
    if (!dst->primes->copy_from(src->primes)) {
        return false;
    }
