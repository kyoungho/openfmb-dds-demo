...
public class HelloWorldPublisher {
    ...
    public static void Main(string[] args) {
        ...
        if (args.Length >= 3)
        {
            ...
            {
                Console.Error.WriteLine("Unknown profile argument " + args[2] + "using " + profile);
            }
        }
        ...
        */
        ...
        try
            ...
            HelloWorldPublisher.publish(
                domain_id, sample_count, profile);
        }
        catch(DDS.Exception)
        {
    ...
    static void publish(int domain_id, int sample_count, String profile) {
        ...
        */
        ...
        ++count) {
            Console.WriteLine("Writing HelloWorld Secure, count {0}", count);
