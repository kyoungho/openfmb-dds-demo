...
with this example:
- HelloWorldTopicQuery_publisher.cs
- HelloWorldTopicQuery_subscriber.cs
...
i86Win32VS2013, run:
   ...
   rtiddsgen -example  i86Win32VS2013 -ppDisable -language C# 
...
After running rtiddsgen, you will see messages that look like this:
	...
	WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not 
        be overwritten : <example_dir>\HelloWorldTopicQuery_publisher.cs
	WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not
        be overwritten : <example_dir>\HelloWorldTopicQuery_subscriber.cs
	WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not 
...
two projects, HelloWorldTopicQuery_publisher and HelloWorldTopicQuery_subscriber, 
with the Win32 Release setting (or Win32 Debug settings if you prefer).


Running the example applications
================================

In your library search path, you MUST have the location of the RTI Connext DDS 
shared libraries, because the applications will load the shared object 
dynamically when they start.

On one machine, run the publisher:

  > bin\[x64\]<Debug|Release>-VS<vs_version>\HelloWorldTopicQuery_publisher.exe <options>
...
On another machine or terminal, run the subscriber:

  > bin\[x64\]<Debug|Release>-VS<vs_version>\HelloWorldTopicQuery_subscriber.exe <options>
