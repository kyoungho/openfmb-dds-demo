...
{
    char * position = NULL;
    const char *METHOD_NAME = "ThroughputCommandKindPlugin_serialize";
    ...
    if(serialize_sample) {
        ...
        if (*sample != THROUGHPUT_COMMAND_IDLE && *sample != THROUGHPUT_COMMAND_START && *sample != THROUGHPUT_COMMAND_COMPLETE){
            RTICdrLog_exception(
                METHOD_NAME, 
    ...
    void *endpoint_plugin_qos)
{
    ...
    char * position = NULL;
    DDS_Enum enum_tmp;
    const char *METHOD_NAME = "ThroughputCommandKindPlugin_deserialize_sample";
                ...
                *sample=THROUGHPUT_COMMAND_COMPLETE;
                ...
                default:
                {
                    ...
                    if (ap->acceptUnknownEnumValue) {
                        ThroughputCommandKind_initialize(sample);
                    } else {
    ...
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    ...
    sample = new (std::nothrow) ThroughputCommand ;
    if (sample == NULL) {
        return NULL;
    }
...
{
    return ThroughputCommand_copy(dst,(const ThroughputCommand*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    ThroughputCommandKindPluginSupport_print_data(
        (const ThroughputCommandKind*) &sample->command, "command", indent_level + 1);
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_sample) {
        ...
        if(!ThroughputCommandKindPlugin_serialize(
            endpoint_data,
            (const ThroughputCommandKind*) &sample->command,
            stream,
    ...
    void *endpoint_plugin_qos)
{
    ...
    RTIBool result;
    const char *METHOD_NAME = "ThroughputCommandPlugin_deserialize";
    ...
    const ThroughputCommand * sample) 
{
    ...
    current_alignment += ThroughputCommandKindPlugin_get_serialized_sample_size(
        ...
        current_alignment, (const ThroughputCommandKind*) &sample->command);
    ...
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    ...
    sample = new (std::nothrow) Throughput ;
    if (sample == NULL) {
        return NULL;
    }
...
{
    return Throughput_copy(dst,(const Throughput*) src);
}
...
ThroughputPluginSupport_create_key_ex(RTIBool allocate_pointers){
    ...
    key = new (std::nothrow) ThroughputKeyHolder ;
    ...
    void *endpoint_plugin_qos)
{
    ...
    RTIBool result;
    const char *METHOD_NAME = "ThroughputPlugin_deserialize";
    if (drop_sample) {} /* To avoid warnings */
