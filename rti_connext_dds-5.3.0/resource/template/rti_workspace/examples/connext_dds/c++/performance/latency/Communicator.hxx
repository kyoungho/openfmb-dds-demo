...
class Communicator {
  ...
  public:
    ...
    virtual DDS_Boolean prepare(Latency *,
...
/* Define RTI_IPV6 to support IPV6 transport */
  ...
  protected:
    DDS_Boolean create_dds_entities(const Latency *instance,
...
class RtiDdsSenderCommunicator : public RtiDdsCommunicator {
  ...
  public:
    ...
    virtual DDS_Boolean prepare(Latency *instance,
                                char* mcast_recv_addr,
