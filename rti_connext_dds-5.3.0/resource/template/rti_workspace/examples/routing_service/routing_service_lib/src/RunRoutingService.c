...
#endif
{
    ...
    */
    ...
    /* 
     * RTI Routing Service provides the finalize_globals() method for users who
     * want to release global resources used by any service instance. Uncomment 
     * the following block of code for clean destruction of these resources. 
     */
    if (!RTI_RoutingService_finalize_globals()) {
        perror ("Error: failed to finalize global resources\n");
        return -1;
    }
