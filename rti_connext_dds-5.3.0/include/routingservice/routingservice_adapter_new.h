...
/*
 * @(#)routingservice_adapter_new.h    generated by: makeheader    Thu Jun 22 14:19:51 2017
 *
...
typedef void (*RTI_RoutingServiceAdapterEntityNew_UpdateFcn)(
    void * entity_data,
    const struct RTI_RoutingServiceProperties * properties,
    RTI_RoutingServiceEnvironment * env);

 
typedef void (*RTI_RoutingServiceAdapterEntityNew_GetGuidFcn)(
    void * entity_data,
...
typedef void  (*RTI_RoutingServiceStreamReaderNew_GetKeyValueFcn)(
        void * stream_reader_data,
        RTI_RoutingServiceSample key_holder, 
        const struct RTI_RoutingServiceInstanceHandle * handle,        
        RTI_RoutingServiceEnvironment * env);
...
typedef 
void (*RTI_RoutingServiceStreamReaderNew_DeleteStreamRequestFcn)(
    void * stream_reader_data,
    int service_id,
...
typedef 
void (*RTI_RoutingServiceStreamReaderNew_CreateStreamRequestFcn)(
    void * stream_reader_data,
...
struct RTI_RoutingServiceStreamReaderNew{
    ...
    /* @brief Handles the retrieval of the key value for the corresponding
     intance handle */
    RTI_RoutingServiceStreamReaderNew_GetKeyValueFcn get_key_value;
    /*i @brief Handles the return of the StreamReader GUID */
    RTI_RoutingServiceAdapterEntityNew_GetGuidFcn get_guid;    
    /*i @brief Handles the create of a stream request */
    RTI_RoutingServiceStreamReaderNew_CreateStreamRequestFcn 
            create_stream_request;
    /*i @brief Handles the deletion of a stream request */
    RTI_RoutingServiceStreamReaderNew_DeleteStreamRequestFcn 
            delete_stream_request;
    /*i @brief Handles the update of the StreamReader */
    RTI_RoutingServiceAdapterEntityNew_UpdateFcn update;
...
typedef void (*RTI_RoutingServiceStreamWriterNew_WriteWithParamsFcn)(
    void * stream_writer_data,
    const RTI_RoutingServiceSample sample,
    const struct RTI_RoutingServiceWriteParams * params,
    RTI_RoutingServiceEnvironment * env);
...
struct RTI_RoutingServiceStreamWriterNew{
    ...
    RTI_RoutingServiceStreamWriterNew_WriteWithParamsFcn write_w_params;
    /*i @brief Handles the return of the StreamReader GUID */
    RTI_RoutingServiceAdapterEntityNew_GetGuidFcn get_guid;
...
typedef 
void (*RTI_RoutingServiceStreamWriterListenerNew_OnOutputStreamRequestReceivedCallback)(
    void * stream_writer_data,
    void * listener_data,
    const struct RTI_RoutingServiceOutputStreamRequestStatus * status);


struct RTI_RoutingServiceStreamWriterListenerNew {
    /*i \dref_StreamWriterListener_listener_data
    */
    void * listener_data;
    /*i \dref_StreamWriterListener_on_output_stream_request_received
    */
    RTI_RoutingServiceStreamWriterListenerNew_OnOutputStreamRequestReceivedCallback 
...
(*RTI_RoutingServiceConnectionNew_CreateStreamWriterFcn)(
        ...
        const struct RTI_RoutingServiceStreamInfo * stream_info,
        const struct RTI_RoutingServiceProperties * properties,
        const struct RTI_RoutingServiceStreamWriterListenerNew * listener,
        RTI_RoutingServiceEnvironment * environment);
...
typedef
struct RTI_RoutingServiceStreamReaderNew * 
(*RTI_RoutingServiceConnectionNew_LookupBuiltinStreamReaderFcn)(
    void * connection_data,
...
struct RTI_RoutingServiceConnectionNew{
    ...
    RTI_RoutingServiceConnectionNew_LookupBuiltinStreamReaderFcn lookup_builtin_stream_reader;
