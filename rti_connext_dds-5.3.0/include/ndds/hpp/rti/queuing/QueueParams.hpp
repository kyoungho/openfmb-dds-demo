...
public:
    ...
    void validate() const
    {
        ...
        if (shared_subscriber_name_.empty()) {
            throw dds::core::InvalidArgumentError("Shared subscriber is required");
        }
    }
...
public:
    ...
    QueueProducerParams& enable_sample_replication(const bool enable)
    {
        enable_sample_replication_ = enable;
        return *this;
    }
    
    const bool& enable_wait_for_ack() const
    {
...
public:
    ...
    const bool& enable_availability() const
    {
     ...
     */
    QueueConsumerParams& enable_availability(const bool enable)
    {
...
public:
     ...
     */
    QueueRequesterParams& enable_availability(const bool enable)
    {
        enable_availability_ = enable;
        return *this;
    }
     ...
     */
    QueueRequesterParams& enable_sample_replication(const bool enable)
    {
        enable_sample_replication_ = enable;
        return *this;
    }
     ...
     */
    QueueRequesterParams& enable_wait_for_ack(const bool enable)
    {
        enable_wait_for_ack_ = enable;
        return *this;
    }
...
public:
     ...
     */
    QueueReplierParams& enable_availability(const bool enable)
    {
        enable_availability_ = enable;
        return *this;
    }
     ...
     */
    QueueReplierParams& enable_sample_replication(const bool enable)
    {
        enable_sample_replication_ = enable;
        return *this;
    }
     ...
     */
    QueueReplierParams& enable_wait_for_ack(const bool enable)
    {
        enable_wait_for_ack_ = enable;
        return *this;
    }
