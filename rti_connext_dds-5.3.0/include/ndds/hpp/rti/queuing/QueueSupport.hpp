...
public:
    dds::core::xtypes::StructType GUID_Type_code_;
    dds::core::xtypes::StructType avaliability_type_code_;

    ConsumerAvailabilitySupportTypeHolder() 
        : GUID_Type_code_(create_GUID_type()),
          avaliability_type_code_(create_availability_type())
    {

    }
private:
    dds::core::xtypes::StructType create_GUID_type()
    {
    ...
    dds::core::xtypes::StructType create_availability_type()
    {
        using namespace dds::core::xtypes;

        StructType availability_type("ConsumerAvailability");
        availability_type.extensibility_kind(ExtensibilityKind::EXTENSIBLE);
        availability_type.add_member(Member("consumer_guid", GUID_Type_code_).key(true));
...
public:
            ...
            const rti::core::Guid& consumer_guid) 
    {
        ...
        DynamicData dynamic_data_guid(type_codes_.GUID_Type_code_);
...
private:
    static ConsumerAvailabilitySupportTypeHolder type_codes_;
};
