...
/*
 * @(#)dds_c_trust_plugins.h    generated by: makeheader    Thu Jun 22 14:17:49 2017
 *
...
typedef struct DDS_DataHolder Token;

typedef Token DDS_HandshakeMessageToken;

typedef Token DDS_IdentityToken;

typedef Token DDS_AuthenticatedPeerCredentialToken;

typedef Token DDS_PermissionsToken;

typedef Token DDS_PermissionsCredentialToken;
